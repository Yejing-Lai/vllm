...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # Kill-switch for eager-mode load-time kernel fusion (see
    # vllm/model_executor/eager_fusion.py). Enabled by default under
    # enforce_eager; set to 0 to disable and fall back to unfused kernels.
    "VLLM_EAGER_FUSION": lambda: bool(int(os.getenv("VLLM_EAGER_FUSION", "1"))),
